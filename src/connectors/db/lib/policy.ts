...
function _boundarySemicolons(
  ...
  // ⚡ Bolt Optimization: Use a sequential array rather than a Set for tracking
  // index positions. This eliminates conversion and O(N log N) sorting overhead
  // since the indices naturally emerge monotonically increasing.
