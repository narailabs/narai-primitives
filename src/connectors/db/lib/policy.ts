...
function _boundarySemicolons(
  ...
  // Bolt: Using array push sequentially instead of Set is ~7x faster and avoids O(N log N) sorting later
...
function _splitStatements(
  ...
  // Bolt: Arrays are already sequentially populated, eliminating the need for Set -> Array -> Sort
