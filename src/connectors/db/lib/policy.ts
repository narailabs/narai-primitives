...
function _boundarySemicolons(
  ...
  // We use an array instead of a Set to avoid subsequent Array.from().sort() overhead.
  // Because we iterate through `sql` sequentially, the indices are naturally sorted.
