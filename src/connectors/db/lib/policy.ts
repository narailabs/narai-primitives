...
function _boundarySemicolons(
  ...
  // ⚡ Bolt: Use an array instead of a Set. Since we iterate left-to-right,
  // indices are naturally monotonically increasing and unique.
  // This avoids O(N log N) sorting and Set allocation overhead later.
