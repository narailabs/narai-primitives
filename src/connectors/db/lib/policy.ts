...
function _boundarySemicolons(
  ...
  // ⚡ Bolt: Use an array instead of a Set to avoid redundant Array.from + sort later.
  // Sequential string iteration naturally produces monotonically increasing indices.
...
function _splitStatements(
  ...
  // ⚡ Bolt: b1 and b2 are already naturally sorted arrays, avoiding O(N log N) overhead.
