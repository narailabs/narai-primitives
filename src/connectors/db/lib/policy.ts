...
function _splitStatements(
  ...
  // ⚡ Bolt: _boundarySemicolons returns sequentially populated arrays (number[]),
  // which naturally produces sorted indices. Avoid Set instantiation and sorting
  // which adds O(N log N) overhead for what is inherently an O(N) linear scan.
