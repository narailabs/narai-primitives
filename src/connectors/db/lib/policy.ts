...
function _boundarySemicolons(
  ...
  // ⚡ Bolt: Use O(N) array tracking instead of O(N log N) Set-to-Array sorting.
  // Since we iterate through the SQL string sequentially, discovered semicolon
  // indices naturally occur in monotonically increasing order.
