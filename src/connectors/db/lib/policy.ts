...
function _boundarySemicolons(
  ...
  // Use array instead of Set. Array is populated sequentially during iteration,
  // resulting in naturally ordered elements without sorting overhead.
...
function _splitStatements(
  ...
  // No need to sort as the boundaries are naturally added sequentially
