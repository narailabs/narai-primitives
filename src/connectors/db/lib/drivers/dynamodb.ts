...
export class DynamoDriver extends DatabaseDriver {
  ...
  async getSchemaAsync(
    ...
    try {
      ...
      // ⚡ Bolt Optimization: Batch DescribeTable calls in chunks of 10 to avoid
      // N+1 sequential overhead while keeping under AWS API rate limits.
