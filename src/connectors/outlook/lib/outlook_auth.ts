/**
 * outlook_auth.ts — Microsoft Graph delegated OAuth, refresh-token flow.
 *
 ...
 * `ConfidentialClientApplication` per `OutlookAuth` instance. Access tokens
 ...
 * as the `OutlookAuth` instance does. On restart, the env-supplied
...
export async function loadOutlookCredentials(): Promise<OutlookCredentials | null> {
...
/**
 * Process-instance MSAL wrapper. One instance per `OutlookClient`. Lazy-inits
