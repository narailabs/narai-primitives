...
import { ensureSettingsHook } from "../../../plugins/connector-creator/skills/connector-creator/lib/settings-wiring.mjs";
import { registerConnector } from "../../../plugins/connector-creator/skills/connector-creator/lib/connector-registry.mjs";
...
describe("connector-creator end-to-end (shell-gate flavor)", () => {
  let scope: string;
