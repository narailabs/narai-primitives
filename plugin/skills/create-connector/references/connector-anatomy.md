...
- `<workspace>/notion-agent-connector/src/index.ts` — full factory call with 7 actions
- `<workspace>/notion-agent-connector/src/lib/notion_client.ts` — full Result-envelope client
- `<workspace>/connector-toolkit/src/index.ts` — toolkit's public API surface (the contract you're consuming)
